...
public class PlaceOrderPageOrderFromCartTwoAdapter extends RecyclerView.Adapter<PlaceOrderPageOrderFromCartTwoAdapter.MyViewHolder> {
    ...
    public PlaceOrderPageOrderFromCartTwoAdapter(){
    ...
    public PlaceOrderPageOrderFromCartTwoAdapter(Context context, ArrayList<CartPageList> list)
    {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.proceed_with_payment_layout_two,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        CartPageList productsList = list.get(position);
        ...
        holder.prodVariation.setText(productsList.getVariations());


        int quantity = productsList.getProductQuantity();
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot : dataSnapshot.getChildren())
                {
                    ...
                    if(user1.getId().equalsIgnoreCase(user.getUid()))
                    {
                        ...
                        Intent intent = new Intent("ProceedWithPaymentDataCartTwo");
