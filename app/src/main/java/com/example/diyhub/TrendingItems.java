...
public class TrendingItems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trending_items);
        getImages();
    }
    ...
    private void initRecyclerView(){
        ...
        RecyclerView recyclerView = findViewById(R.id.recylcerTrending1);
        recyclerView.setLayoutManager(layoutManager);
        RecyclerViewAdapterTrending adapter = new RecyclerViewAdapterTrending(this, mNames, mImageUrls);
        recyclerView.setAdapter(adapter);
    }
    private void initRecyclerView1(){
        Log.d("Trending Items", "initRecyclerView: init recyclerview");

        LinearLayoutManager layoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        RecyclerView recyclerView = findViewById(R.id.recylcerTrending2);
        recyclerView.setLayoutManager(layoutManager);
        RecyclerViewAdapterTrendingItems adapter = new RecyclerViewAdapterTrendingItems(this, mNames, mImageUrls, seq);
        recyclerView.setAdapter(adapter);
    }
}