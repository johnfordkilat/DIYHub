...
public class ShopsNearYou extends AppCompatActivity {
    ...
    private void initRecyclerView(){
        ...
        RecyclerView recyclerView = findViewById(R.id.recylcerShopsNearYou1);
        recyclerView.setLayoutManager(layoutManager);
        RecyclerViewAdapterShopsNear adapter = new RecyclerViewAdapterShopsNear(this, mNames, mImageUrls);
    ...
    private void initRecyclerView1(){
        ...
        RecyclerView recyclerView = findViewById(R.id.recylcerShopsNearYou2);
        recyclerView.setLayoutManager(layoutManager);
        RecyclerViewAdapterShopsNearYou adapter = new RecyclerViewAdapterShopsNearYou(this, mNames, mImageUrls, seq);
        recyclerView.setAdapter(adapter);
    }
}