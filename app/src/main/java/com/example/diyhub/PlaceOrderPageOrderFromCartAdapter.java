...
public class PlaceOrderPageOrderFromCartAdapter extends RecyclerView.Adapter<PlaceOrderPageOrderFromCartAdapter.MyViewHolder> {
    ...
    public PlaceOrderPageOrderFromCartAdapter(){
    ...
    public PlaceOrderPageOrderFromCartAdapter(Context context, ArrayList<CartPageList> list)
    {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.numOfItems.setText(String.valueOf(productsList.getProductQuantity()));
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot snapshot : dataSnapshot.getChildren())
                {
                    ...
                    if(user1.getId().equalsIgnoreCase(user.getUid()))
                    {
                        ...
                        Intent intent = new Intent("ProceedWithPaymentDataCart");
