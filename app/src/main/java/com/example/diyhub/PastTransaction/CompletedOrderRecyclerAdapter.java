...
public class CompletedOrderRecyclerAdapter extends RecyclerView.Adapter<CompletedOrderRecyclerAdapter.MyViewHolder>{
    ...
    ArrayList<CompletedOrderList> list;
    ...
    public CompletedOrderRecyclerAdapter(Context context, ArrayList<CompletedOrderList> list)
    {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        CompletedOrderList completedOrderList = list.get(position);
        holder.prodName.setText(completedOrderList.getProductName());
        holder.date.setText(completedOrderList.getDate());
