...
public class OrdersAcceptedList implements Parcelable {
    ...
    public OrdersAcceptedList(){

    }

    public OrdersAcceptedList(String productName, String productQuantity, String prodImage, String prodID, String orderType, String paymentOption, String itemCode,
    ...
    public OrdersAcceptedList(Parcel in){
    ...
    public static final Parcelable.Creator<OrdersAcceptedList> CREATOR = new Parcelable.Creator<OrdersAcceptedList>() {
        public OrdersAcceptedList createFromParcel(Parcel in) {
            return new OrdersAcceptedList(in);
        }

        public OrdersAcceptedList[] newArray(int size) {
            return new OrdersAcceptedList[size];
        }
    };
}
