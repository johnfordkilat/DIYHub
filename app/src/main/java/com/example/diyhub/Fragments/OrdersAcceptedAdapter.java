...
public class OrdersAcceptedAdapter extends RecyclerView.Adapter<OrdersAcceptedAdapter.MyViewHolder> {
    ...
    public OrdersAcceptedAdapter(Context context, ArrayList<OrdersList> list)
    {
        ...
        holder.nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(list.get(position).getOrderType().equalsIgnoreCase("Standard")){
                    Intent intent = new Intent(context, OrderDetailAcceptedStandardPage.class);
                    ...
                    Intent intent = new Intent(context, OrderDetailAcceptedCustomizationPage.class);
                    Bundle bundle = new Bundle();
                    bundle.putParcelableArrayList("list", list);
                    intent.putExtra("position", String.valueOf(position));
                    intent.putExtras(bundle);
