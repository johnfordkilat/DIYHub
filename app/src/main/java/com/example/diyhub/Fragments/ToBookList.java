...
public class ToBookList implements Parcelable {
    ...
    public ToBookList(String productName, String productQuantity, String prodImage, String prodID, String orderType, String paymentOption, String itemCode,
    ...
    public static final Parcelable.Creator<ToBookList> CREATOR = new Parcelable.Creator<ToBookList>() {
        public ToBookList createFromParcel(Parcel in) {
            return new ToBookList(in);
        }

        public ToBookList[] newArray(int size) {
            return new ToBookList[size];
        }
    };
}
