...
public class ViewPageAdapterProductsBuyer extends PagerAdapter {
    ...
    public ViewPageAdapterProductsBuyer(Context context, List<ProductDetailsImagesList> imagesLists) {
