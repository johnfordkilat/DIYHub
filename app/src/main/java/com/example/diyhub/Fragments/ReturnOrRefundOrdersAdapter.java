...
public class ReturnOrRefundOrdersAdapter extends RecyclerView.Adapter<ReturnOrRefundOrdersAdapter.MyViewHolder> {
    ...
    public ReturnOrRefundOrdersAdapter(Context context, ArrayList<OrdersList> list)
    {
