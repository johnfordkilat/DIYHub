...
public class OrdersAdapter extends RecyclerView.Adapter<OrdersAdapter.MyViewHolder> {
    ...
    public OrdersAdapter(Context context, ArrayList<OrdersList> list)
    {
        ...
        holder.nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(list.get(position).getOrderType().equalsIgnoreCase("Standard")){
                    Intent intent = new Intent(context, OrderDetailStandardPage.class);
                    ...
                    Intent intent = new Intent(context, OrderDetailCustomizationPage.class);
                    Bundle bundle = new Bundle();
                    bundle.putParcelableArrayList("list", list);
                    intent.putExtra("position", String.valueOf(position));
                    intent.putExtras(bundle);
