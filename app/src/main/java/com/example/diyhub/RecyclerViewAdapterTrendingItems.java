...
public class RecyclerViewAdapterTrendingItems extends RecyclerView.Adapter<RecyclerViewAdapterTrendingItems.ViewHolder> {
    ...
    public RecyclerViewAdapterTrendingItems(Context context, ArrayList<String> names, ArrayList<String> imageUrls, ArrayList<String> sequence) {
        mNames = names;
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, StandardProductPage.class);
